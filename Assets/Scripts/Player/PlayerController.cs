...
public class PlayerController
{
    ...
    public PlayerController(PlayerView playerView, PlayerScriptableObject playerScriptableObject)
    {
        ...
        EventService.Instance.OnLightsOffByGhostEvent.AddListener(LightsSwitchedOffByGhost);
    }
    ...
    ~PlayerController()
    {
        ...
        EventService.Instance.OnKeyPickedUp.AddListener(onKeysPickedUp);
        EventService.Instance.OnLightsOffByGhostEvent.RemoveListener(LightsSwitchedOffByGhost);
    ...
    private  void LightsSwitchedOffByGhost()
    {
        playerState = PlayerState.InDark;
